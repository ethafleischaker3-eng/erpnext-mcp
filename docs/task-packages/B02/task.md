...
| 12 | 治理修订评审记录 | `docs/governance/changes/变更记录-2026-09-12-任务包治理修订.md` | CHG-20260912-001（2026-09-12） |
...
| `docs/governance/任务包登记表.md` 的 B02 行 | 更新 B02 版本、状态、角色、路径与证据位置 | gjg | 是 | 仅更新 B02 行；其他任务行实质变化另走相应任务或变更流程 |
...
| D03 | 更新后的任务包登记表 | `docs/governance/任务包登记表.md` | B02 行与本文件一致，表格结构未改变 |
